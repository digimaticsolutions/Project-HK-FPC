...
// if (Mage::getStoreConfig('ced_csmarketplace/general/activation',Mage::app()->getStore()->getId())){
// class Smartwave_All_Model_Core_Layout extends Ced_CsMarketplace_Model_Layout
// {
