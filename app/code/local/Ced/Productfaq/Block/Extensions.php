 ...
 */
 class Ced_Productfaq_Block_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$modules = Mage::helper('productfaq')->getCedCommerceExtensions(false,true);
		//print_r($modules);die;
	...
	protected function _getFieldHtml($fieldset, $moduleName,$currentVersion = '0.0.1',$moduleProductName = '')
    {
		...
		if(strlen($data) == 0) {
			$title = Mage::helper('productfaq')->__('Enter the valid license after that you have to click on Save Config button.');
