 ...
 */
final class Ced_Productfaq_MainController extends Mage_Core_Controller_Front_Action 
{
	public function checkAction() {
		...
		if($data && isset($data['module_name'])) {			
			...
			$json['module_license'] = Mage::getStoreConfig(Ced_Productfaq_Block_Extensions::HASH_PATH_PREFIX.strtolower($data['module_name']));
	...
	public function infoAction() {
		...
		if(strlen($signature) > 0 && $signature == '4ec6aa57fd9a8fc7473c8def05e79bd2') {	
			$json = array('success'=>0,'information'=>Mage::helper('productfaq')->getEnvironmentInformation(),'installed_modules'=>Mage::helper('productfaq')->getCedCommerceExtensions(false,true));
			$json['success'] = 1;
