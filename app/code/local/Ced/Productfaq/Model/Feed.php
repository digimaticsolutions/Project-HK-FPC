 ...
 * @author 		CedCommerce Core Team <coreteam@cedcommerce.com>
 */
class Ced_Productfaq_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    ...
    {	
		$cedModules = Mage::helper('productfaq')->getCedCommerceExtensions();
        ...
        $feedXml = $this->getFeedData(Mage::helper('productfaq')->getEnvironmentInformation());
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
			...
			foreach ($feedXml->channel->item as $item) {
				if(Mage::helper('productfaq')->isAllowedFeedType($item)) {
