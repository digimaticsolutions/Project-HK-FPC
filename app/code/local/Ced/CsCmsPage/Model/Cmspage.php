...
class Ced_CsCmsPage_Model_Cmspage extends Mage_Core_Model_Abstract
{
    ...
    public function getAvailableStatuses()
    {
        $statuses = new Varien_Object(array(
            self::STATUS_ENABLED => Mage::helper('cscmspage')->__('Enabled'),
            self::STATUS_DISABLED => Mage::helper('cscmspage')->__('Disabled'),
        ));
