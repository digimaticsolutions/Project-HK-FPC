...
class Ced_CsCmsPage_Model_Vendorcms extends Mage_Core_Model_Abstract
{
	...
	{
		$this->_init('cscmspage/vendorcms');
	}
	/**
	 * Innitialize Available Cms Statuses ...
	 */
    ...
    /**
	 * Innitialize Vendor Cms Page Statuses
	 */
