...
*/  
 class Ced_StorePickup_Block_Adminhtml_Extensions_Details extends Mage_Adminhtml_Block_Abstract
{
	...
	protected function _toHtml() {
		...
		$url = $this->getUrl('storepickup/adminhtml_cedpopup/cedpop');
		
		if(count($params) > 0) $url = Mage::helper('storepickup')->addParams($url,$params,false);
