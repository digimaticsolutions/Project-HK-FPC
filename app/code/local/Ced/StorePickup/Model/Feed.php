...
*/ 
class Ced_StorePickup_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    const XML_USE_HTTPS_PATH    = 'system/adminnotification/use_https';
    const XML_FEED_URL_PATH     = 'system/storepickup/feed_url';
    const XML_FREQUENCY_PATH    = 'system/storepickup/frequency';
    const XML_LAST_UPDATE_PATH  = 'system/storepickup/last_update';
    ...
    {	
		$cedModules = Mage::helper('storepickup')->getCedCommerceExtensions();
        ...
        $feedXml = $this->getFeedData(Mage::helper('storepickup')->getEnvironmentInformation());
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
			...
			foreach ($feedXml->channel->item as $item) {
				if(Mage::helper('storepickup')->isAllowedFeedType($item)) {
