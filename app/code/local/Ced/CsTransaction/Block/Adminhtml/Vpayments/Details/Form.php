 ...
 */
class Ced_CsTransaction_Block_Adminhtml_Vpayments_Details_Form extends Ced_CsMarketplace_Block_Adminhtml_Vpayments_Details_Form
{
    /**
	 * prepare form
	 *
					...
					'payment_details' => array(
						'fields' => array(
							...
							'total_shipping_amount' => array(
								'label' => Mage::helper('csmarketplace')->__('Total Shipping Amount'),
								'value' =>  Mage::app()->getLocale()->currency($model->getBaseCurrency())->toCurrency($model->getData('total_shipping_amount')),
								'type'	=> 'label',
							),
							'base_amount' => array(
