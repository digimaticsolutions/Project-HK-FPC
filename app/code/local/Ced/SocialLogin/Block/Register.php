...
class Ced_SocialLogin_Block_Register extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
		...
		$this->clientYahoo = Mage::getSingleton('sociallogin/yahoo_client');
	...
	protected function _yahooEnabled()    
	{   
	     return (bool) $this->clientYahoo->isEnabled();
    }	
