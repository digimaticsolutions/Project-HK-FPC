 ...
 * @author     	CedCommerce Core Team <coreteam@cedcommerce.com>
 */
class Ced_CsMultiShipping_Block_Vsettings_Shipping_Methods extends Ced_CsMarketplace_Block_Vendor_Abstract
{
	/**
	...
	{	
		...
		$form->setAction($this->getUrl('*/methods/save',array('section'=>Ced_CsMultiShipping_Model_Vsettings_Shipping_Methods_Abstract::SHIPPING_SECTION)))
			->setId('form-validate')
			->setMethod('POST')
		...
		if(count($methods) >0 ) {
			...
			$form->addField('default_message','note',array('text'=>Mage::helper('csmultishipping')->__('No Shipping Methods are Available.')));
		}
		$this->setForm($form);
		return $this;
	}
