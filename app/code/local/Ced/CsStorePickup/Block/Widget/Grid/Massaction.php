 ...
 */
class Ced_CsStorePickup_Block_Widget_Grid_Massaction extends Mage_Adminhtml_Block_Widget_Grid_Massaction
{
	/**
	 * 
	 * setting template
	...
	{
		parent::__construct();
		$this->setTemplate('csstorepickup/widget/grid/massaction.phtml');
