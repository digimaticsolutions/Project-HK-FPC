 ...
 */
class Ced_CsProductfaq_Block_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    //  print_r($groupCollection->getData());die("lkjmln");
            foreach ($groupCollection as $group) {
            	//echo $group->getId() ; die("lk");
            	//print_r($group->getData());die("lkn");
//             	if($group['attribute_group_name'] =='Design')
//             	{
//             		continue;
//             	}
            ...
            if(Mage::getStoreConfig('ced_vproducts/general/relatedproducts',$product->getStoreId())){
	            $this->addTab('related', array(
	            		...
	            		'url'       => Mage::getUrl('*/*/related', array('_current' => true,'_secure' => Mage::app()->getFrontController()->getRequest()->isSecure())),
	            		'class'     => 'ajax',
	            ));
            }
            ...
            if(Mage::getStoreConfig('ced_vproducts/general/upsells',$product->getStoreId())){
	            $this->addTab('upsell', array(
	            		...
	            		'url'       => Mage::getUrl('*/*/upsell', array('_current' => true,'_secure' => Mage::app()->getFrontController()->getRequest()->isSecure())),
	            		'class'     => 'ajax',
	            ));
            }
            ...
            //		$this->getLayout()->createBlock('productfaq/adminhtml_tabs_tabid')->toHtml()),
            			 'url'       => Mage::getUrl('csproductfaq/*/faqs', array('_current' => true,'_secure' => Mage::app()->getFrontController()->getRequest()->isSecure())),
            			  'class'     => 'ajax',
            			));
            }
            ...
            if(Mage::getStoreConfig('ced_vproducts/general/crosssells',$product->getStoreId())){
	            $this->addTab('crosssell', array(
	            		...
	            		'url'       => Mage::getUrl('*/*/crosssell', array('_current' => true,'_secure' => Mage::app()->getFrontController()->getRequest()->isSecure())),
	            		'class'     => 'ajax',
	            ));
            }
            ...
            if (!$product->isGrouped() && Mage::getStoreConfig('ced_vproducts/general/customoptions',$product->getStoreId())) {
                $this->addTab('customer_options', array(
                    ...
                    'url'   => Mage::getUrl('*/*/options', array('_current' => true,'_secure' => Mage::app()->getFrontController()->getRequest()->isSecure())),
                    'class' => 'ajax',
                ));
            }
