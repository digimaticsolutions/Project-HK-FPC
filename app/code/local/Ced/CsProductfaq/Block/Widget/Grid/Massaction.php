 ...
 */
class Ced_CsProductfaq_Block_Widget_Grid_Massaction extends Mage_Adminhtml_Block_Widget_Grid_Massaction
{
	/**
	 * 
	 * setting template
	...
	{
		parent::__construct();
		$this->setTemplate('productfaq/widget/grid/massaction.phtml');
