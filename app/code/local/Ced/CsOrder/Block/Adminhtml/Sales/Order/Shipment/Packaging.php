 ...
 */
class Ced_CsOrder_Block_Adminhtml_Sales_Order_Shipment_Packaging extends Mage_Adminhtml_Block_Sales_Order_Shipment_Packaging
{
    ...
    public function getConfigDataJson()
    {
        ...
        if ($shipmentId) {
            ...
            $createLabelUrl = $this->getUrl('*/shipment/createLabel', $urlParams);
            $itemsGridUrl = $this->getUrl('*/shipment/getShippingItemsGrid', $urlParams);
            ...
            $createLabelUrl = $this->getUrl('*/shipment/save', $urlParams);
            $itemsGridUrl = $this->getUrl('*/shipment/getShippingItemsGrid', $urlParams);
