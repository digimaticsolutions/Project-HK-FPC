 ...
 */
class Ced_CsOrder_Block_Adminhtml_Sales_Order_Invoice_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Admin session
     *
    ...
    public function getBackUrl()
    {
		...
		$vorder = Mage::getModel("csmarketplace/vorders")->getVorderByInvoice($this->getInvoice());
		
        return $this->getUrl(
            'csorder/vorders/view',
            array(
                'order_id'  => $vorder->getId(),
                'active_tab'=> 'order_invoices','_secure'=>true
            ));
    }
    ...
    {
        return $this->getUrl('*/*/capture', array('invoice_id'=>$this->getInvoice()->getId(),'_secure'=>true));
    }

    public function getVoidUrl()
    {
        return $this->getUrl('*/*/void', array('invoice_id'=>$this->getInvoice()->getId(),'_secure'=>true));
    }

    public function getCancelUrl()
    {
        return $this->getUrl('*/*/cancel', array('invoice_id'=>$this->getInvoice()->getId(),'_secure'=>true));
    }
    ...
    public function getEmailUrl()
    {
        return $this->getUrl('*/*/email', array(
            ...
            'invoice_id'=> $this->getInvoice()->getId(),'_secure'=>true
        ));
    }
    ...
    {
        if ($flag == 'invoice') {
		 	return $this->_updateButton('back', 'onclick', 'setLocation(\'' . $this->getUrl('csorder/invoice',array('_secure'=>true)) . '\')');
        }
        return $this;
    }
