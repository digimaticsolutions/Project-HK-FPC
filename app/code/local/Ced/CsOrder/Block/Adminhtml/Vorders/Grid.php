 ...
 */
class Ced_CsOrder_Block_Adminhtml_Vorders_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	/**
	 * Constructor
	 */
	...
	protected function _prepareMassaction(){
		...
		$this->getMassactionBlock()->addItem('status', array(
				 ...
				 'url'  => $this->getUrl('*/*/massStatus', array('_current'=>true,'_secure'=>true)),
				 'additional' => array(
						 'visibility' => array(
								 'name' => 'status',
								 'type' => 'select',
	...
	protected function _prepareCollection(){
		...
		if(!$flag) {
			...
			$collection->getSelect()->join($orderTable ,'main_table.order_id LIKE  CONCAT("%",'.$orderTable.".increment_id".' ,"%")',array('created_at'));
  ...
  protected function _prepareColumns(){
	//$currency = (string) Mage::getStoreConfig(Mage_Directory_Model_Currency::XML_PATH_CURRENCY_BASE);
			...
			$this->addColumn('shipping_amount',array(
				'header'=> Mage::helper('catalog')->__('Shipping Amount'),
		   ...
		   $this->addColumn('action',
				array(
					...
					'type'      => 'action',
					'getter'     => 'getId',
					'renderer' => $this->getLayout()->createBlock('csorder/adminhtml_vorders_grid_renderer_view'),
					'filter'    => false,
					'sortable'  => false
			));
  ...
  /**
	 * add vendor name filter to collection
	 *
	 * @return object
	 */
  ...
  /**
	...
	public function getRowUrl($row){
		...
		return $this->getUrl('adminhtml/sales_order/view', array('order_id' => $order->getId(),'_secure'=>true));
  	}
