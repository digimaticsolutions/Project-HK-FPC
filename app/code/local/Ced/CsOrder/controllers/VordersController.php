 ...
 */
class Ced_CsOrder_VordersController extends Ced_CsMarketplace_Controller_AbstractController {
    ...
    public function preDispatch()
    {
       ...
       if(!Mage::helper('csorder')->isActive()){
          ...
          $this->_forward($action, 'vorders', 'csmarketplace', $params);
       }
    }
    ...
    public function addCommentAction()
    {
        if ($order = $this->_initOrder()) {
            try {
                ...
                $block=$this->getLayout()->createBlock('csorder/adminhtml_sales_order_view_history','order_comments')->setTemplate('sales/order/view/history.phtml');
