 ...
 */
class Ced_CsOrder_MultishippingController extends Mage_Checkout_Controller_Action {
	...
	/**
     * Action for redirecting back to address
     *
     */
...
//    }
    ...
    public function overviewPostAction()
    {
        ...
        try {
            ...
            $this->_redirect('csorder/multishipping/success');
