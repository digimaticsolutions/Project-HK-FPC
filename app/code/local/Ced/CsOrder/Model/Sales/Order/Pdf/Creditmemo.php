 ...
 */
class Ced_CsOrder_Model_Sales_Order_Pdf_Creditmemo extends Mage_Sales_Model_Order_Pdf_Creditmemo
{
    ...
    public function getPdf($creditmemos = array())
    {
        ...
        foreach ($creditmemos as $creditmemo) {
            ...
            $page  = $this->newPage();
			$vorder=Mage::getModel('csorder/vorders')->getVorderByCreditmemo($creditmemo);
