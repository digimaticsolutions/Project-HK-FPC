        ...
        if ($groupId) {
  			$vendorAttributes = Mage::getModel('eav/entity_attribute')->getCollection()->setAttributeGroupFilter($groupId);
   			$vendorAttributes->getSelect()->joinLeft(
				Mage::getConfig()->getTablePrefix().'ced_csmarketplace_vendor_form_attribute',
				'main_table.attribute_id = '.Mage::getConfig()->getTablePrefix().'ced_csmarketplace_vendor_form_attribute.attribute_id',
				array('is_visible','store_id','use_in_registration','position_in_registration','use_in_left_profile','position_in_left_profile')
			);
