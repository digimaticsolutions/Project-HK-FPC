...
class Ced_CsVendorProductAttribute_Block_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{

    /**
     * Set the Form Template for Frontend Form of Attribute 
     */
	public function __construct()
	{

	parent::__construct();
    $this->setTemplate('csattribute/edit/form.phtml');
	}
	
	/**
	 * Prepare the layout in According to Vendor Panel Theme
	 */
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('include_in_attribute_set', 'select', array(
        		'name'      => 'include_in_attribute_set',
        		'label'     => Mage::helper('catalog')->__('Include in Attribute Set'),
        		'title'     => Mage::helper('catalog')->__('Include in Attribute Set'),
        		'note'      => Mage::helper('catalog')->__('Want to Include this Attribute in Your Unique Attribute Set'),
        		'values'    => $yesnoSource,
        ));
