...
window.onload = function() {
    new PeriodicalExecuter(function() {
        if (!$('select_store_pickup') && googleMap.listStore.length) {
            if ($$('input[value="storepickup_storepickup"]').first()) {
                if(storepickupElement1){
                    if($$('input[value="storepickup_storepickup"]').first().up('li')){
                        $$('input[value="storepickup_storepickup"]').first().up('li').insert({
                        ...
                        $$('input[value="storepickup_storepickup"]').first().up('dt').insert({
                            bottom: storepickupElement1
                        });
                        $$('input[value="storepickup_storepickup"]').first().up('dt').insert({
                            bottom: storepickupElement2
            ...
            if ($$('input[value="storepickup_storepickup"]').first()) {
                if ($$('input[value="storepickup_storepickup"]').first().checked) {
...
function updateStoreShippingPrice(price) {
    var s_method = 's_method_121_storepickup_storepickup';
...
//    $$('input[value="storepickup_storepickup"]').first().click();
}
...
function updateShippingTime() {
    new Ajax.Request(changeTimeUrl, {
        ...
        onSuccess: function(){
            if($$('input[value="storepickup_storepickup"]').first())$$('input[value="storepickup_storepickup"]').first().click();
            storepickupElement2 = $('selected_st_info').clone(true);
